// scripts/import-nce2.mjs
// 新概念英语第二册：从 JSON 导入数据库
// 源：docs/new_concept_english/2_format/*.json（由 convert-nce2.mjs + fill-translations-nce2.mjs 生成）
// 用法：先启动 dev server (pnpm dev)，再运行：node scripts/import-nce2.mjs
...
const SRC_DIR = new URL('../docs/new_concept_english/2_format/', import.meta.url).pathname

const textbook = { stage: '其他', name: '新概念英语第二册', publisher: '外研社' }
